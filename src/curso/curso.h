	...
	public:
		...
		inline Curso(std::string id="empty",
					 ...
					 int plazasMax=0):id_(id), nombre_(nombre), descripcion_(descripcion),
					 				  precio_(precio), fechaInicio_(fechaInicio),
									  fechaFinal_(fechaFinal), plazasCubiertas_(plazasCubiertas),
									  plazasMax_(plazasMax), alcance_(0.0){}
		...
		inline float get_precio() const {return precio_;}
